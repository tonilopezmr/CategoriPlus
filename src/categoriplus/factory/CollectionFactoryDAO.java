...
import categoriplus.dataccesobject.CollectionCategoriaDAO;
import categoriplus.dataccesobject.CollectionProductoDAO;
 ...
 */
public class CollectionFactoryDAO implements FactoryDAO{

    private final DBConfig dbconfig;
    
    public CollectionFactoryDAO(DBConfig config) {
        this.dbconfig = config;
    }
    
    @Override
    public CategoriaDAO getCategoriaDAO() {
        return new CollectionCategoriaDAO();
    }

    @Override
    public ProductoDAO getProductoDAO() {  
        return new CollectionProductoDAO();
    }
}
